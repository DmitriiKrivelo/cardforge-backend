...
\restrict b0BDwroLohcBdQRh6vWUm989963vuzbqPKBbNDFXAb0WwmxefYPitNQewVYZqNP
...
--
-- Name: business_cards; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.business_cards_id_seq OWNER TO postgres;

--
-- Name: business_cards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: card_views; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: card_views_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.card_views_id_seq OWNER TO postgres;

--
-- Name: card_views_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: card_views id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: business_cards; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: card_views; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: card_views_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards business_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards business_cards_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: card_views card_views_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: business_cards business_cards_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: card_views card_views_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: card_views card_views_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict b0BDwroLohcBdQRh6vWUm989963vuzbqPKBbNDFXAb0WwmxefYPitNQewVYZqNP
